...
if __name__ == '__main__':
    ...
    # start = timer()
    set_frame_camera(cap)
    # set_frame_camera(cap1)
    # set_frame_camera(cap2)
    ...
    while cap.isOpened():
        ...
        # holistic.show_action(image1, face=False)
        # holistic.show_action(image2, face=False)
        ...
        # cv2.imshow("Front", cv2.flip(image1, 1))
